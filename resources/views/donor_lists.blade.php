...
@php
    $all_donor_lists = \App\Models\BloodDonor::all();
@endphp

        @foreach ($all_donor_lists as $single_donor)
        <tr>
            <td>{{ $single_donor->fullname }}</td>
            <td>{{ $single_donor->bloodgroup }}</td>
            <td>{{ $single_donor->mobile }}</td>
            <td>{{ $single_donor->email }}</td>
            <td>{{ $single_donor->town }}</td>
            <td>{{ $single_donor->state }}</td>
        </tr>
        @endforeach
